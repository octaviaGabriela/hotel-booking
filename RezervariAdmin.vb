...
Imports System.Text
Public Class FormRezervariAdmin
    Dim Con As New SqlConnection("Data Source=DESKTOP-A4RFJNL\SQLSERVEROCT;Initial Catalog=HOTELmanagement;Integrated Security=True;MultipleActiveResultSets=True")
    ...
    Private Sub FormRezervariAdmin_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Populate()
    ...
    Private Sub ButtonUtilizatoriRA_Click(sender As Object, e As EventArgs) Handles ButtonUtilizatoriRA.Click
        Me.Close()
        Utilizatori.Show()
    End Sub

    Private Sub ButtonHartaCamereRA_Click(sender As Object, e As EventArgs) Handles ButtonHartaCamereRA.Click
        Me.Close()
        HartaCamerelorAdmin.Show()
    End Sub

    Private Sub ButtonCORNRA_Click(sender As Object, e As EventArgs) Handles ButtonCORNRA.Click
        Me.Close()
        CreeazaORezervareNouaAdmin.Show()
    End Sub

    Private Sub ButtonTarifCamereRA_Click(sender As Object, e As EventArgs) Handles ButtonTarifCamereRA.Click
        Me.Close()
        TarifCamereAdmin.Show()
    End Sub

    Private Sub ButtonTarifDinamicRA_Click(sender As Object, e As EventArgs) Handles ButtonTarifDinamicRA.Click
        Me.Close()
        TarifDinamicAdmin.Show()
    End Sub

    Private Sub ButtonClientiRA_Click(sender As Object, e As EventArgs) Handles ButtonClientiRA.Click
        Me.Close()
        ClientiAdmin.Show()
    End Sub

    Private Sub ButtonDelogareRA_Click(sender As Object, e As EventArgs) Handles ButtonDelogareRA.Click
        Me.Close()
        LogareCont.Show()
    End Sub


    'buton Rezervare efectuata
    Private Sub ButtonRezEFECTRa_Click(sender As Object, e As EventArgs) Handles ButtonRezEFECTRa.Click
        If LabelNumeRA.Text = "" And LabelPrenumeRA.Text = "" And LabelTelefonRA.Text = "" And LabelSexRA.Text = "" And LabelProvenientaRA.Text = "" And LabelTipCameraRA.Text = "" And LabelNumarCameraRA.Text = "" And LabelAvansRA.Text = "" And LabelTotalDePlataRA.Text = "" And LabelRestDePlataRA.Text = "" And LabelStatusRezervareRA.Text = "" And LabelDIRA.Text = "" And LabelDSRA.Text = "" Then
            MsgBox("Nu a fost selectată nicio rezervare ")
